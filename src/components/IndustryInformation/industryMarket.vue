          ...
          <div class="left">
              ...
              <div class="ccy-info">
                <div class="topright">
                  ...
                  <ul>
                    <li
                      @click="TonewPath(item.id)"
                      v-for="(item, index) in weekliList.slice(0, 6)"
                      :key="index + '%%'"
            ...
            <div class="one">
              ...
              <div class="onetop">
                ...
                <div class="onetopr">
                  ...
                  <div class="onetopr2">
                    <ul>
                      <li
                        v-for="(item, index) in jingcai1List.slice(8, 12)"
                        :key="index + '**'"
                        :class="[index == 0 ? 'ccy-css' : 'ccy-cssn']"
                        @click="TonewPath(item.id)"
                      >
              ...
              <div class="onemide">
                <div
                  class="zhuangti"
                  v-for="item in jingcai2List.slice(0, 4)"
                  :key="item.id"
                  @click="TonewPath(item.id)"
                >
                  <el-image
        ...
        <el-main>
          <div class="right">
            ...
            <div class="righttext">
              ...
              <el-divider class="ccy-drvider"></el-divider>
              <li
                v-for="(item, index) in ClickDataList.slice(0, 6)"
                :key="index"
                @click="TonewPath(item.id)"
                class="ccy-rightLi"
                style="width: 180px"
