  ...
  <div class="user-view lxl-body">
    <div class="lxl-box">
      ...
      <el-container style="border: 1px solid #eee" class="user-container">
        ...
        >
          <el-menu :default-active="isPath" active-text-color=" #ff4026" router>
            <!-- active-text-color高亮颜色 -->
            <!-- router:是否使用 vue-router 的模式，启用该模式会在激活导航时以 index 作为 path 进行路由跳转 -->
            <el-menu-item index="/infoManger">首页</el-menu-item>
            ...
            <el-menu-item index="/shopInfoManage">完善店铺信息</el-menu-item>
          </el-menu>
        </el-aside>
