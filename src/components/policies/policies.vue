        ...
        <div class="left">
          ...
          <div class="lsec1">
            ...
            <div class="lsec1rword">
              <ul>
                <li class="lsec1rword0" v-for="item in list"
                    :key="item.id">
                  <div class="lsec1rword1"><a href="#"><i></i>{{ item.title }}</a></div>
...
export default {
  data() {
    return {
      ...
      imgList:[
     {
        url:'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1603359265154&di=19774a64799e2d332a8eb44544657d20&imgtype=0&src=http%3A%2F%2Fimg0.imgtn.bdimg.com%2Fit%2Fu%3D3312660160%2C2721714514%26fm%3D214%26gp%3D0.jpg'
     },
     {
        url:'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1603375961126&di=9dcbdebf13ca2470160f25b587bfb0cc&imgtype=0&src=http%3A%2F%2Fwww.nanhuwang.com%2Fuploads%2Fallimg%2Fc160716%2F14DD000CY30-235223.jpg'
     },
     {
        url:'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1603359349325&di=26e989dcc305c640f8048bc9dea5be1c&imgtype=0&src=http%3A%2F%2Fimg4.99114.com%2Fgroup1%2FM00%2F9C%2FB7%2FwKgGTFmSrReASFg7AADvpocFa3c547.jpg'
     }
    ],
    times: ''
    }
  ...
  methods: {
    // 获取左侧第一栏列表数据
    async getList() {
        const { data: res } = await this.reqM2Service(`/info/policies/1/8`,'','post')
        console.log(res)
        if (res.code !== 20000) {
    ...
    // 获取媒体列表数据
    async getMtList() {
        const { data: res } = await this.reqM2Service(`/info/policies/search/searchByTypeId/1316746032893267968/1/8`,'','post')
        console.log(res)
        if (res.code !== 20000) {
        return this.$message.error('获取列表失败！')
      }
